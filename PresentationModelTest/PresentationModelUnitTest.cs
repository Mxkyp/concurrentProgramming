...
namespace TP.ConcurrentProgramming.Presentation.Model.Test
{
  ...
  public class PresentationModelUnitTest
  {
    ...
    private class UnderneathLayerFixture : BusinessLogicAbstractAPI
    {
      ...
      public override void Start(int numberOfBalls, Action<IPosition, BusinessLogic.IBall> upperLayerHandler, double width, double height, double borderSize, double ballDia)
      {
